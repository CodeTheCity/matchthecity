...
namespace :deploy do
  ...
  task :rebuild_venues, roles: :app do
    run_remote_rake "import:venues"
  end

  task :rebuild_sa_venues, roles: :app do
  ...
  task :rebuild_rgu, roles: :app do
    run_remote_rake "import:rgu_sport_classes"
  end

  task :rebuild_te, roles: :app do
